...
def subfinder():
    subprocess.check_output('docker run --rm --name '+container_name+' kali-tool:2.0 subfinder -d '+domain+' -silent > '+homedir+'/recon/data/'+target+'/temp/'+output+' || true', shell=True)
